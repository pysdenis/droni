...
<section class="from-[#657e90] bg-gradient-to-b to-black mb-0">
	<div class="container text-white pt-16">
		<h2 class="font-semibold text-white text-center mb-8">Lorem ipsum</h2>
		<div class="flex">
